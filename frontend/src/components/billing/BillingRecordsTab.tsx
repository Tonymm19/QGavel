...
import { Plus, Edit2, Receipt, Calendar, Building2, Search } from 'lucide-react';
...
const BillingRecordsTab: React.FC = () => {
  ...
  const fetchBillingRecords = async () => {
    try {
      ...
      const response = await fetch(API_ENDPOINTS.adminBillingRecords(), {
        headers: {
  ...
  return (
    <div>
      ...
      {filteredRecords.length === 0 ? (
        <div className="bg-white rounded-xl p-4 border border-slate-200 text-center py-12">
